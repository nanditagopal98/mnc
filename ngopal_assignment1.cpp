...
bool mycomp(listNodeModule a,listNodeModule b)
{
...
{
	int sockfd,newfd;
	vector<struct listNodeModule>remoteList;
	...
	void printBlockList(char *IP)
	{
		char hostname[200],service[100];
                ...
                socklen_t size=sizeof(s);
		int i;
		vector<listNodeModule>tempBlock;
